...
namespace L05
{
    class Program
    {
        ...
        static async Task Initialize()
        {
            ...
            + "AccountName=azurestoragecorina"
            + ";AccountKey=k2jq757uRXv1/+u+RQjqaA4wy8iptRZeGPvlCOjBhZn/yerGd601LzqudEowlaGTFaM9Ufsq2+MZdqft3Mqq7w=="
        ...
        private static async Task GetAllStudentsFromOld()
        {
            ...
            await AddNewStudent("General", count);
            for (int i = 0; i < n; i++)
            {
